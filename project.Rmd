...
The grading scheme for this project is the same as for the assignments. The best reports will be logically put together and easy to read, making it clear what you are  hoping to find out, how you are investigating that and why, and summarizing concisely what you discovered.

The project is due at 11:59pm on the last day of classes (December 7, 2020) on Quercus. There will be a place to hand it in, in with the Assignments. Your project report should be an HTML, Word `docx` or PDF file, in the same way that your assignments were.
