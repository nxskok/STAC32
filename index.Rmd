...
- 2019-10-19 13:15: just so that you know: next week there is *no assignment* and also *no tutorials*. Assignment 6 (not quite finished yet) will be due on Oct 31; there will be tutorials again that week.

- 2019-10-19 13:00: your exams are all scanned. We have an online grading system, which means that you will get an online copy of your marked exam back afterwards. I will shortly start my share of the grading, but in the meantime, [my solutions](midterm-20199.pdf) and [the figures](midterm-20199-f.pdf). My solutions will get added to as we grade (especially if people do stuff that we weren't expecting).
